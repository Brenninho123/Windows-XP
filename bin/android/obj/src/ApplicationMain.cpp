...
HX_LOCAL_STACK_FRAME(_hx_pos_b3b993f62d801895_251___init__,"::ApplicationMain_obj","__init__",0x253d991d,"::ApplicationMain_obj.__init__","ApplicationMain.hx",251,0x0780ded5)
...
void ApplicationMain_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_b3b993f62d801895_251___init__)
HXDLIN( 251)		 ::Dynamic init = ::hx::ClassOf< ::lime::app::Application >();
            	}


void ApplicationMain_obj::main(){
            	HX_STACKFRAME(&_hx_pos_6fcf922b66429816_18_main)
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Game",12,20,38,2f),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Ander",e4,66,0d,b6));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Game",12,20,38,2f));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Windows XP",95,6e,ca,e2));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.ander.windowsXP",24,36,1d,4a));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Windows XP",95,6e,ca,e2))
...
HXLINE( 111)		 ::openfl::display::Preloader preloader =  ::openfl::display::Preloader_obj::__alloc( HX_CTX , ::openfl::display::DefaultPreloader_obj::__alloc( HX_CTX ));
