...
HXLINE(  61)			::ManifestResources_obj::rootPath = HX_("",00,00,00,00);
            		}
HXLINE(  74)		 ::Dynamic data;
HXDLIN(  74)		 ::Dynamic manifest;
HXDLIN(  74)		 ::Dynamic bundle;
HXLINE(  76)		{
...
HXLINE(  74)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
