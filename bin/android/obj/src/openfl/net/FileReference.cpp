...
HX_LOCAL_STACK_FRAME(_hx_pos_069fe0fa1a76d977_1502_saveFileDialog_onSelect,"openfl.net.FileReference","saveFileDialog_onSelect",0x20977dab,"openfl.net.FileReference.saveFileDialog_onSelect","openfl/net/FileReference.hx",1502,0x825195e0)
...
bool FileReference_obj::browse(::Array< ::Dynamic> typeFilter){
            	HX_STACKFRAME(&_hx_pos_069fe0fa1a76d977_576_browse)
...
void FileReference_obj::save( ::Dynamic data,::String defaultFileName){
            	HX_STACKFRAME(&_hx_pos_069fe0fa1a76d977_1080_save)
...
void FileReference_obj::saveFileDialog_onSelect(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_069fe0fa1a76d977_1502_saveFileDialog_onSelect)
HXDLIN(1502)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("select",fc,1a,33,6a),null(),null()));
            	}
