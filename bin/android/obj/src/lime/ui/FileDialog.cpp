...
bool FileDialog_obj::browse( ::lime::ui::FileDialogType type,::String filter,::String defaultPath,::String title){
            	HX_STACKFRAME(&_hx_pos_9e2e2667a273619d_99_browse)
HXLINE( 100)		if (::hx::IsNull( type )) {
HXLINE( 100)			type = ::lime::ui::FileDialogType_obj::OPEN_dyn();
            		}
HXLINE( 103)		bool _hx_tmp;
HXDLIN( 103)		bool _hx_tmp1;
HXDLIN( 103)		bool _hx_tmp2;
HXDLIN( 103)		if (::hx::IsNotNull( defaultPath )) {
HXLINE( 103)			_hx_tmp2 = (defaultPath.length > 0);
            		}
            		else {
HXLINE( 103)			_hx_tmp2 = false;
            		}
HXDLIN( 103)		if (_hx_tmp2) {
HXLINE( 103)			_hx_tmp1 = ::sys::FileSystem_obj::exists(defaultPath);
            		}
            		else {
HXLINE( 103)			_hx_tmp1 = false;
            		}
HXDLIN( 103)		if (_hx_tmp1) {
HXLINE( 103)			_hx_tmp = ::sys::FileSystem_obj::isDirectory(defaultPath);
            		}
            		else {
HXLINE( 103)			_hx_tmp = false;
            		}
HXDLIN( 103)		if (_hx_tmp) {
HXLINE( 110)			::String lastChar = defaultPath.charAt((defaultPath.length - 1));
HXLINE( 117)			if ((lastChar != HX_("/",2f,00,00,00))) {
HXLINE( 119)				defaultPath = (defaultPath + HX_("/",2f,00,00,00));
            			}
            		}
...
HXLINE( 286)		this->onCancel->dispatch();
