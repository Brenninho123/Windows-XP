...
HX_LOCAL_STACK_FRAME(_hx_pos_d83344e4dbfeb65c_232_postUICallback,"lime.system.JNI","postUICallback",0x8d567168,"lime.system.JNI.postUICallback","lime/system/JNI.hx",232,0x21970b7f)
...
HXLINE(  87)		className = ::lime::_hx_system::JNI_obj::transformClassName(className);
HXLINE(  88)		return  ::lime::_hx_system::JNIMemberField_obj::__alloc( HX_CTX ,( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_jni_create_field(className,memberName,signature,false)) ));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(JNI_obj,createMemberField,return )
 ...
 ::Dynamic JNI_obj::createMemberMethod(::String className,::String memberName,::String signature,::hx::Null< bool >  __o_useArray,::hx::Null< bool >  __o_quietFail){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_d83344e4dbfeb65c_106_createMemberMethod)
HXLINE( 107)		::lime::_hx_system::JNI_obj::init();
HXLINE( 110)		className = ::lime::_hx_system::JNI_obj::transformClassName(className);
HXLINE( 111)		 ::hx::Object * handle = ::lime::_internal::backend::native::NativeCFFI_obj::lime_jni_create_method(className,memberName,signature,false,quietFail);
HXLINE( 113)		if (::hx::IsNull( handle )) {
HXLINE( 115)			if (quietFail) {
HXLINE( 117)				return null();
            			}
HXLINE( 120)			HX_STACK_DO_THROW(((HX_("Could not find member function \"",c5,79,42,b4) + memberName) + HX_("\"",22,00,00,00)));
            		}
HXLINE( 123)		 ::lime::_hx_system::JNIMethod method =  ::lime::_hx_system::JNIMethod_obj::__alloc( HX_CTX ,( ( ::Dynamic)(handle) ));
HXLINE( 124)		return method->getMemberMethod(useArray);
            	}
...
HXLINE( 143)		className = ::lime::_hx_system::JNI_obj::transformClassName(className);
HXLINE( 144)		return  ::lime::_hx_system::JNIStaticField_obj::__alloc( HX_CTX ,( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_jni_create_field(className,memberName,signature,true)) ));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(JNI_obj,createStaticField,return )
 ...
 ::Dynamic JNI_obj::createStaticMethod(::String className,::String memberName,::String signature,::hx::Null< bool >  __o_useArray,::hx::Null< bool >  __o_quietFail){
            		bool useArray = __o_useArray.Default(false);
            		bool quietFail = __o_quietFail.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_d83344e4dbfeb65c_164_createStaticMethod)
HXLINE( 165)		::lime::_hx_system::JNI_obj::init();
HXLINE( 168)		className = ::lime::_hx_system::JNI_obj::transformClassName(className);
HXLINE( 169)		 ::hx::Object * handle = ::lime::_internal::backend::native::NativeCFFI_obj::lime_jni_create_method(className,memberName,signature,true,quietFail);
HXLINE( 171)		if (::hx::IsNull( handle )) {
HXLINE( 173)			if (quietFail) {
HXLINE( 175)				return null();
            			}
HXLINE( 178)			HX_STACK_DO_THROW(((HX_("Could not find static function \"",f1,b7,fa,62) + memberName) + HX_("\"",22,00,00,00)));
            		}
HXLINE( 181)		 ::lime::_hx_system::JNIMethod method =  ::lime::_hx_system::JNIMethod_obj::__alloc( HX_CTX ,( ( ::Dynamic)(handle) ));
HXLINE( 182)		return method->getStaticMethod(useArray);
            	}
...
HXLINE( 193)		return ::lime::_internal::backend::native::NativeCFFI_obj::lime_jni_get_env();
            	}
...
HXLINE( 206)			 ::Dynamic method = ::lime::_hx_system::CFFI_obj::load(HX_("lime",15,17,b3,47),HX_("lime_jni_init_callback",50,af,63,63),1,false);
HXLINE( 207)			method(::lime::_hx_system::JNI_obj::onCallback_dyn());
            		}
            	}
...
void JNI_obj::postUICallback( ::Dynamic callback){
            	HX_STACKFRAME(&_hx_pos_d83344e4dbfeb65c_232_postUICallback)
HXDLIN( 232)		::lime::_internal::backend::native::NativeCFFI_obj::lime_jni_post_ui_callback(::hx::DynamicPtr(callback));
            	}
