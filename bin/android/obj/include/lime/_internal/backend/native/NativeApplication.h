...
class HXCPP_CLASS_ATTRIBUTES NativeApplication_obj : public ::hx::Object
{
	...
	public:
		...
		static void __boot();
		 ...
		 ::Dynamic handle;
		 ::lime::_internal::backend::native::_NativeApplication::OrientationChangeListener deviceOrientationListener;
		int pauseTimer;
		...
		void handleJNIOrientationEvent(int newOrientation);
		::Dynamic handleJNIOrientationEvent_dyn();
