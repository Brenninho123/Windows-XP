...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Game", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		app.meta.set("company", "Breno");
		app.meta.set("file", "Game");
		app.meta.set("name", "Windows XP");
		app.meta.set("packageName", "com.ander.windowsXP");
